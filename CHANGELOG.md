...
- Avoid an intermediate reversed list when sorting known entries; normalize the streak card presenter's name.
- Add deterministic long-history correctness checks and an opt-in JVM recomputation profiling task without timing thresholds.
