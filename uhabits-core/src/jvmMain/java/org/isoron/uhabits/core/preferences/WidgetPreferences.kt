...
class WidgetPreferences @Inject constructor(private val storage: Preferences.Storage) {
    var scheduledReminderHabitIds: LongArray
        get() = storage.getLongArray("scheduled-reminder-habits", longArrayOf())
        set(value) = storage.putLongArray("scheduled-reminder-habits", value)
